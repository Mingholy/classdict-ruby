...
Book.create![{ title: "当代美国史", school: "中国科学院大学", publish_time: '2015-09-01', description: "这门课主要介绍美国第二次世界大战以后的社会政治、外交关系的演化，重点有两个：一个是冷战，另一个是民权运动，二者塑造、改变了美国社会，而且二者之间有极大的关联。这门课从杜鲁门到奥巴马，研究内容包括原子弹的制造和使用、冷战的开启、朝鲜战争、麦卡锡主义、苏联卫星升天的冲击、民权运动、越南战争、妇女运动、环保运动、冷战结束、计算机网络和生物新技术兴起、9/11恐怖袭击及其后果、气候变化、奥巴马的当选、经济大衰退的影响等。我们关注的问题包括：国际政治和国内政治如何互相影响？技术是美国当代史的主要驱动力吗？美国从1945 到2014年有那些变化、又有哪些没有变化？我们的主要学习方式为课下阅读和写作、课上讲演、讨论、视频，以求获得没够近代史的知识，并改进批判性思维、写作和口头交流的能力。
", clicks: 1001},
{ title: "科学幻想与现代科技", school: "中国科学院大学", publish_time: '2015-09-01', description: "教学目的和要求： 本课程是为国科大研究生开设的公共选修课，旨在通过对包括科幻文学、科幻电影等各种科幻艺术发展历程的介绍与作品赏析，引导学生思考科技发展对现代文化的影响、科学技术与人类的关系，以及科学哲学、科技伦理等问题，增强学生对什么是科学、什么是科学精神等问题的理解，提高学生的人文素养
", clicks: 1001},
{ title: "临床心理学", school: "中国科学院大学", publish_time: '2015-09-01', description: "本课程为心理学学科各专业博士、硕士研究生的学科专业基础课。 临床心理学(Clinical Psychology)是运用心理学的知识和原理，帮助病人纠正自己的精神和行为障碍，通过心理学的技术指导和培养健全的人，以便有效地适应环境和更有创造力。临床心理学属于应用心理学的范畴，各种心理问题和心理障碍的人是临床心理学的主要研究对象，但正常的心理过程也是临床心理学研究的范围。
", clicks: 1002},
{ title: "女性主义电影与批评", school: "中国科学院大学", publish_time: '2015-09-01', description: "世界电影距今有百年历史，而女性主义及其电影批评和电影创作在探索中也走过四十多年的道路。随着女性主义本身学术化和知识体系化的发展，了解女性主义思想，了解女性主义美学和艺术，一方面已成为当代学人知识结构中的一种学养的必需，另一方面，鉴于我们的社会性别文化体系和结构中，两性关系依然是一个复杂的问题领域，培养清晰正确的社会性别意识，既是社会人文的重要主题之一，也是一种现代公民的人文觉悟和素养。从这两个需要出发，借助对女性主义电影的理论和创作的介绍分析，可以明晰和提高学生的社会性别觉悟以及电影艺术修养。
", clicks: 1003},
{ title: "军事科技史", school: "中国科学院大学", publish_time: '2015-09-01', description: "教学目的、要求 使学生对军事科学技术的发展历程有所了解，开阔学生的眼界，加强学生的国防意识，提高学生的综合素质。 预修课程 （略） 教 材 （略） 主要内容 从古代到近现代军事装备及技术的基本状况和演变过程，历史上军事科学技术对战争以及国家安全的影响。
", clicks: 1004},
{ title: "中国现代作家系列讲座", school: "中国科学院大学", publish_time: '2015-09-01', description: "内容提要： 中国现代作家系列人物之一：老舍之死与口述历史 中国现代作家系列人物之二： 二战风云中的战地记者—萧乾 中国现代作家系列人物之三：徐志摩---“你是人间的四月天” 中国作家学会会员、散文学会会员、老舍研究会常务理事 
", clicks: 1005},
{ title: "巴洛克及其时代", school: "中国科学院大学", publish_time: '2015-09-01', description: "教学目的和要求： 本课程是非艺术类专业本科生的选修课，旨在增进学生的艺术修养、审美能力、完善知识结构、扩展知识面、提高学生素质。 本课程以讲述及分析欧洲17世纪美术史中的主要流派、艺术家、作品其产生的文化、历史背景，从而提高学生鉴赏、分析、理解美术作品的能力，丰富学生的精神世界。
", clicks: 1006},
{ title: "诗词鉴赏", school: "中国科学院大学", publish_time: '2015-09-01', description: "一、通过诗歌参证历史或通过历史印证诗歌，寻找诗中的文化、文化中的诗。文学不仅在短短的方寸之间为我们展示了过去的琼楼玉宇，逼真地复制了那在过去岁月中也许早已为人们淡忘了的生动具体的细节，而且还为我们塑造了一个活生生的人群，一种生活的韵味，一片奇妙的风光。不习之，何以知之？ 　　　二、诗歌能培养诗人的才情、哲人的思辩、历史学家的深沉。经典诗词可以使现代人在物欲横流而灵魂放逐的年代有一块属于自己的精神家园，并可以在其中诗意栖居。 　　　三、“一代有一代之文学”，从上古的神话到明清小说，每一个朝代都有其独领风骚的文学作品和文学现象，方今盛世，我们正应当将这些宝贵精神财富继承与传承下去
", clicks: 1007},
{ title: "导航与通讯", school: "中国科学院大学", publish_time: '2015-09-01', description: "介绍全球卫星导航系统的基本理论，是卫星导航领域的技术入门必修课程，内容涵盖导航发展、卫星导航、系统时间产生、信号处理、测定轨、组合导航等方面。目的是使学生全面、系统了解卫星导航基础知识，培养学生在卫星导航与通讯方面的基本研究能力，具备开展卫星导航与通讯专业研究的基础技能。 导航与通讯是当代人们生产、生活的重要方式之一，为人们的出行、购物、旅游、交际、沟通提供了快捷与便利。有必要了解生产、生活中广泛应用的导航与通讯方式和手段。
", clicks: 1008},
{ title: "天文学史", school: "中国科学院大学", publish_time: '2015-09-01', description: "为天文学及相关研究生普及天文学史及与之有关的天文学基础知识,以提高学生的天文素养和综合素质。要求学生了解天文学起源和发展的历史，尤其是近代天文学革命以及天体物理学的重大进展，掌握天文观测技术和分析手段不断发展的基本进程，领会人类探索和认识宇宙在广度和深度上取得的历史性进步，把握天文学与物理学以及光学、电子技术等相关科学技术的密切联系，同时了解太阳系、恒星、星系、宇宙这一知识结构体系的形成及其研究进展，加深理解天文学的基本概念和思想，认识天文学的科学本质、发展规律，及其在整个科学进步和人类文明发展史中的重要意义和作用，从而激发学生进一步学习天文学知识和从事天文观测与研究事业的兴趣和热情。
", clicks: 1009},
{ title: "天体物理中的辐射过程", school: "中国科学院大学", publish_time: '2015-09-01', description: "本课程是为天文学科天体物理专业研究生开设的专业基础课，也可供相关物理专业研究生和天文工作者选修。该课程是联系基础物理和天文学的桥梁，是天体物理研究者的基本工具之一。要求学生熟悉电动力学、电磁理论，对量子力学和相对论理论有初步的了解和简单运用。课程将系统讲述天体物理中辐射过程的基本概念和原理，包括经典辐射理论和（半）量子辐射理论，以及辐射转移，基础性与系统性兼备。课堂讲授着重物理分析，有必需的理论推导，强调理论在各类天体中的应用，适当联系当前天体物理研究中的一些前沿问题。课程还包含较多的、理论联系实际的课后练习，以及综合运用辐射机制和辐射转移的小课题，学生必须有一定的课后练习时间。通过本课程的学习，要求学生掌握天体物理中辐射的基本过程、相应物理、以及应用技能，帮助学生较快进入天体物理研究课题。
", clicks: 1010}]
...
BookNote.create! [
	...
	{	:"3",book_id:3 ,user_id:2 ,content_type:0,content:"出来",pro:0 ,con:0 },
